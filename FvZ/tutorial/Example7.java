...
public class Example7 extends JGEngine 
{
 ...
 {
  drawString("This is a dummy game.  Press space to end the game.", pfWidth()/2,150,0);
  drawString("The ball shoots other balls using a JGTimer.", pfWidth()/2,180,0);
 }
