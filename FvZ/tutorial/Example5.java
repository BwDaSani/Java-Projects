...
public class Example5 extends JGEngine 
{
 ...
 public void paintFrame() 
 {
  ...
  if (getLastKey()!=0) 
  {
   ...
   drawString("You pressed: "+getKeyDesc(getLastKey()), pfWidth()/2, 50, 0);
  } 
  else 
  {
  ...
  drawString("Press the mouse button to launch objects", pfWidth()/2, 110, 0);
  drawString("Press the shift key to launch one object", pfWidth()/2, 140, 0);
  drawString("Press the enter key to remove all objects",pfWidth()/2, 170, 0);
 }
}
