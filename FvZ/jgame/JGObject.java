...
public class JGObject {
 public int hitpoints;//alan's mod
 public int startRow;//alan's mod
 public int startCol;//senyuan's mod
 
 public double originalXspeed;//alan's mod
 public double originalYspeed;//alan's mod
 
 public int type;//alan's mod
 //1= robot
 //2= bullet
 //3= food
 
 public int victimX;//alan's mod
 public int victimY;//alan's mod
 
 public int damage;//alan's mod
 
 public int cost;//alan's mod
 
 public int shootFreq;//alan's mod
 
 public String infoodType;//alan's mod
